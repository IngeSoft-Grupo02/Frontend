...
export const mockDiscounts: Discount[] = [
  ...
  { id: '4', productId: '1', productName: 'Polo Oversized Onyx', name: 'Descuento Polo Onyx', type: 'Porcentaje', value: 15, minUnits: 10, status: 'Activa', usageCount: 5, appliesTo: 'Producto específico' },
  { id: '5', name: 'Descuento aniversario', type: 'Porcentaje', value: 5, minUnits: 5, status: 'Pausada', usageCount: 0, appliesTo: 'Todo el catálogo' }
];
