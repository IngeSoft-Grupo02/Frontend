      ...
      <div className="space-y-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            <Button variant="secondary" className="gap-2 h-12 px-6 rounded-2xl" onClick={() => router.push('/comerciante/carga-masiva')}>
              <Upload size={18} /> Carga masiva
            </Button>
            <Button className="gap-2 h-12 px-6 rounded-2xl shadow-xl shadow-brand-black/10" onClick={() => router.push('/comerciante/products/nuevo')}>
              ...
              <div className="w-full md:w-3/5 p-10 flex flex-col justify-between overflow-y-auto">
                ...
                <div className="flex flex-col gap-3 pt-6 border-t border-brand-neutral-border">
                  <div className="flex gap-3">
                    <Button
                      onClick={() => { router.push(`/comerciante/products/nuevo?edit=${selectedProduct.id}`); setShowDetailId(null); }}
